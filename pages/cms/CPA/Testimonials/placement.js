...
const licensee = () => {
 let blinkOnAddOrEdit = useRef(null)
  ...
  const postData = async () => {
    const result = await axios.post(cmsConstats.addCPACMAPlacement, data, {
      headers: {
  ...
  const fetchData = async () => {
    ...
    setdefaultDeta([...data.placementAlumnis.list])
    console.log(data.placementAlumnis.list);
  }
  ...
  const editData = async (e,ind) => {
    e.preventDefault();

    const result = await axios.post(cmsConstats.editCPACMAPlacement, data, {
      headers: {
        'Content-Type': 'multipart/form-data',
        'Authorization': `JWT ${Token}`
      }
  ...
  const deleteListData = async (ind) => {
    ...
    if (confirm("Data Will Be Deleted Permanently.!")) {
      ...
      const result = await axios.post(cmsConstats.deleteCPACMAPlacement, { id: ind }, {
        headers: {
          'Content-Type': 'multipart/form-data',
          'Authorization': `JWT ${Token}`
        }
    ...
    <>
      ...
      <section className="section fixedPadd">
        <div className="container">
          <h2 className='heading03'>Simandhar Recent US CPA and US CMA Placements</h2>
            ...
            <form action="" method='POST' className='mt-4' onSubmit={edit ? editData : SubmitData}>
              <div className=''>
                ...
                <div className="inputFileds bb wdt-full mt-4">
                  <label htmlFor="" className='title01'>Course / Grade</label>
              ...
              <div className='mt-4'>
                ...
                <div className="inputFileds wdt-full bb" style={{ position: 'relative' }}>
                  <label htmlFor="" className='title01'> Image rq (Image) :</label>
                  <h6 className='dimension'>*Dimensions : 485 * 479 px | Format : .jpg, .png</h6>
                  <div className="filedwrap two-col">
                    <div className="imgBack">
              ...
              <div className=' mt-4'>
              <div className="inputFileds bb wdt-full">
                  <label htmlFor="" className='title01'>Location</label>
