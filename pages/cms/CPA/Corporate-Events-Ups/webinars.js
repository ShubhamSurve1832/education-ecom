...
const webinars = () => {
	...
	const postData = async () => {
		...
		const result = await axios.post(cmsConstats.addWebinars, data, {
			headers: {
	...
	const fetchData = async () => {
		...
		setdefaultDeta([...data.corporateWebinardata.lists])
		console.log(data.corporateWebinardata.lists);
	}
	...
	const editData = async (e) => {
		...
		const result = await axios.post(cmsConstats.editWebinars, data, {
			headers: {
				'Content-Type': 'multipart/form-data',
				'Authorization': `JWT ${Token}`
			}
	...
	const deleteListData = async (ind) => {
		...
		if (confirm("Data Will Be Deleted Permanently.!")) {
			...
			const result = await axios.post(cmsConstats.deleteWebinars, { id: ind }, {
				headers: {
					'Content-Type': 'multipart/form-data',
					'Authorization': `JWT ${Token}`
				}
...
export default AdminWithAuth(webinars)