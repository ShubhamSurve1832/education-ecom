...
const achievers = () => {
    ...
    const postData = async () => {
        ...
        const result = await axios.post(cmsConstats.addCPAOurAchievers, data, {
            headers: {
    ...
    const fetchData = async () => {
        ...
        setdefaultDeta([...data.cpaPage.list])
        // console.log(data.cpaPage.list);
    }
    ...
    const editData = async (e) => {
        ...
        const result = await axios.post(cmsConstats.editCPAOurAchievers, data, {
            headers: {
                'Content-Type': 'multipart/form-data',
                 'Authorization': `JWT ${Token}`
            }
    ...
    const deleteListData = async (ind) => {
        ...
        if (confirm("Data Will Be Deleted Permanently.!")) {
            const result = await axios.post(cmsConstats.deleteCPAOurAchievers, { id: ind }, {
                headers: {
                    'Content-Type': 'multipart/form-data',
                     'Authorization': `JWT ${Token}`
                }
        ...
        <>
            ...
            <section className="section fixedPadd">
                <div className="container">
                    <h2 className='heading03'>What our achievers have to say</h2>
                        ...
                        <form action="" method='POST' className='two-col mt-4'>
                            <div>
                                ...
                                <div className="inputFileds bb wdt-full mt-4">
                                    ...
                                    <input className='wdt-full bordernone title01' name='descriptions' type="text" value={data.descriptions} onChange={(e) => handleInputChange(e)} />
                                </div>
                            </div>
                            <div className=" wdt-full bb" style={{ position: 'relative' }}>
                                <label htmlFor="" className='title01'> Image rq (Website Version) :</label>
                                <h6 className='dimension'>*Dimensions : 485 * 497 px | Format : .jpg, .png</h6>
                                ...
                                <div className="inputFileds wdt-full">
                                    ...
                                    <input className='wdt-full bordernone title01' name='imgAlt' type="text" value={data.imgAlt} onChange={(e) => handleInputChange(e)} />
                                </div>
                            </div>
