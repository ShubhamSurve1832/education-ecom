...
const tieup = () => {
	...
	const fetchData = async () => {
		...
		setdefaultDeta([...data.corporateTab.corporateLogo[0].list1])
		console.log(data);
	}
	...
	const deleteListData = async (ind) => {
		...
		if (confirm("Data Will Be Deleted Permanently.!")) {
			const result = await axios.post(cmsConstats.deleteCorporateTieups, { title: 0, id: ind }, {
				headers: {
					'Content-Type': 'multipart/form-data',
					'Authorization': `JWT ${Token}`
				}
		...
		<>
			...
			<section className="section fixedPadd">
				<div className="container">
					<h3 className='heading03'>Corporate Tieups</h3>
					<div >
...
export default AdminWithAuth(tieup)
