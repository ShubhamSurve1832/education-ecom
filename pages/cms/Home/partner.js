...
const partner = () => {
    ...
    const fetchData = async () => {
        ...
        setdefaultDeta([...data.corporateTab.corporateLogo[1].list1])
        console.log(data.corporateTab);
    }
    ...
    const deleteListData = async (ind) => {
        ...
        if (confirm("Data Will Be Deleted Permanently.!")) {
            const result = await axios.post(cmsConstats.deleteCorporateTieups, { title: 1, id: ind }, {
                headers: {
                    'Content-Type': 'multipart/form-data',
                    'Authorization': `JWT ${Token}`
                }
        ...
        <>
            ...
            <section className="section fixedPadd">
                <div className="container">
                    <h3 className='heading03'>Loan partners</h3>
                    <div >
                        <form action="" method='POST' className='mt-4'>
                            ...
                            <div className="wdt-full bb" style={{ position: 'relative' }}>
                                ...
                                <div className="inputFileds bb wdt-full mt-4">
                                    ...
                                    <input ref={blinkOnAddOrEdit} className='wdt-full bordernone title01'  name='corAlt' type="text" value={data.corAlt} onChange={(e) => handleInputChange(e)} />
                                </div>
...
export default AdminWithAuth(partner)
