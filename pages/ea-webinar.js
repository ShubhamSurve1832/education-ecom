...
const eaWebinar = () => {
    ...
    return (
        <>
            <Head>
                <title>  Enroll Now for only Rs 99 and take the first step toward a rewarding career in Enrolled Agent!</title>
                <meta name="title" content=" Enroll Now for only Rs 99 and take the first step toward a rewarding career in Enrolled Agent! "></meta>
                <meta name="description" content="Are you ready to pave the way to a dynamic career with limitless opportunities? Simandhar Education is thrilled to present an exclusive Enrolled Agent Masterclass for only Rs 99!."></meta>
                <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1"></meta>
                <meta name="keywords" content=" Finance industry event,EA, EA course, 99, 99rs, free, frre ea, free ea course,india, "></meta>
            </Head>
            <div className='event-header'>
                <div className='container-l'>
                    ...
                    <div className='reg-btn'>
                        ...
                        <a href='https://rzp.io/l/CAhwJrR7' ><button className=' blinking-text btn maroon-btn'>Register Now</button></a>
                    </div>
                </div>
            </div>
            <section className='event-banner-section' style={{cursor: "pointer"}} >
                <a href='https://rzp.io/l/CAhwJrR7'>
                <Image loading='lazy' src="https://simandhareducation-files.s3.ap-south-1.amazonaws.com/img/No-Degree-No-Problem_Desktop-View+(3).jpg" fill={true} sizes='100vw' className="resp-img" alt=" SImnadhar EA Webinar" /> </a>
            </section>
          
            <section className='seat-section'>
                <div className='container-l'>
                    <h2>Limited Seats Available</h2>
                    <a href='https://rzp.io/l/CAhwJrR7' ><button className='btn white-btn white-btn-arrow'>Register Now</button></a>
                </div>
            </section>
            <section className='section life-career-section'>
                <div className='container'>
                    <h1 className='heading04' style={{color:'white'}}>Are you ready to pave the way to a dynamic career with limitless opportunities? Simandhar Education is thrilled to present an exclusive Enrolled Agent Masterclass for only <span style={{background: "yellow", color:"black"}}>Rs 99!</span></h1>
                ...
                <div className='container'>
                    ...
                    <div className='why-edu-row'>
                        ...
                        Date: <br/> 16 December 2023
                        </div>
                        <div className='why-edu-box'>
                        Time:<br/>06:30 PM to 8:30 PM
                        </div>
                        <div className='why-edu-box '>
                        Enroll Now for only Rs 99 and take the first step toward a rewarding career in Enrolled Agent!
                        {/* <a href='https://rzp.io/l/CAhwJrR7' ><button className='blinking-text btn maroon-btn'>Register Now</button></a> */}
                ...
                <div className='container'>
                    ...
                    <div className='why-journy-row'>
                        <div className="why-journy-box">
                            <i><AiFillStar /></i>
                            <div>
                                <h2 className='heading04'>Why Enrolled Agent?</h2>
                                <ul>
                                    <li>High-demand profession in taxation.</li>
                                    <li>No college degree required – Open to high school graduates</li>
                                    <li>Unlock pathways to lucrative job opportunities.</li>
                                </ul>
                        ...
                        <div className="why-journy-box">
                            <i><AiFillStar /></i>
                            <div>
                            <h2 className='heading04'>What You'll Gain</h2>
                                <ul>
                                    <li>In-depth knowledge of tax regulations.</li>
                                    <li>Expert insights from industry professionals.</li>
                                    <li>Strategies to excel in the Enrolled Agent exam.</li>
                                </ul>
                        ...
                        <div className="why-journy-box">
                            ...
                            <div>
                                ...
                                <ul>
                                    ...
                                    <li>Anyone seeking a breakthrough in the field of taxation.</li>
                                </ul>
                            </div>
                        </div>
