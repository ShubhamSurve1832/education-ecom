...
const punjab = () => {
    ...
    return (
        <>
            <Head>
                <title>US CPA Course in Punjab Syllabus, Eligibility, Online Coaching, Fees</title>
                <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" />
                <meta name="description" content="US CPA Course in Punjab. Prometric CPA Testing Center in Punjab. Become a US Certified Public Accountant(CPA). Get Online US CPA Live Classes from Simandhar Education." />
                <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1"></meta>
                <meta name="keywords" content="CPA, Certified Public Accountant, US CPA, US CPA Exam, US CPA Course, US CPA Exam in Punjab, US CPA Course in Punjab, Classroom Training, US Certified Public Accountant, CPA USA in Punjab, CPA Training in Punjab, CPA Coaching in Punjab, CPA Classes in Punjab, Simandhar Education, CPA certificate, CPA jobs in India, CPA salary in India, CPA career, CPA requirements, AICPA, NASBA, Prometric, CPA Exam in India, CPA India, CPA Exam Available in India, CPA Course, CPA USA course, CPA USA Course details, CPA in India, US CPA Course, US CPA Exam 
"></meta>
            </Head>
            <Header />
            ...
            <section className='city-top-section'>
                <div className="container">
                    <h2 className='heading03 theme-color'>Become a US Certified Public Accountant (US CPA) from Simandhar Education in Punjab, India</h2>
            ...
            <section className="city-video-section">
                <div className="container">
                    ...
                    <div className="right-form-box">
                        <CommonForm city={true} formName='Punjab' />
                    </div>
                </div>
            </section>
            ...
            <section className='city-para'>
                <div className="container">
                    <div className="box">
                        <h3 className="heading03 text-center">US Certified Public Accountant (US CPA) in Punjab, India</h3>
                        <p className='para' >Simandhar Education is the leading US CPA training provider in Punjab, India. It is the official partner of Becker and channel partner of AICPA. Simandhar Education is notable for its viable online CPA live classes and supporting US CPA aspirants throughout the US CPA training period. Hence, Simandhar Education became the best online US CPA coaching in Punjab, India.</p>
                        <p className='mt-2 para'>AICPA administers the US CPA designation, and it is a globally recognized credential in finance and accounting domains. Over the past few years, the US CPA course demand has been increasing tremendously in India. Opting for the US CPA course in Punjab from Simandhar Education is the right decision to excel in the US CPA career.</p>
                    </div>
                    <div className="box">
                        <h3 className="heading03 text-center">US CPA Exam in India</h3>
                        <p className='para'>NASBA and AICPA have announced good news for the US CPA aspirants: The US CPA exam Prometric centers have begun in India from 1st January 2021. We have 8 Prometric locations in India, and Punjab is one of those. You can now take the US CPA Exam in Punjab, India.</p>
                    </div>
                </div>
            </section>
            ...
            <section className="city-table pt-8">
                <div className="container">
                    <h3 className='heading03 text-center'>US CPA Cost in Punjab, India</h3>
                        ...
                        <table cellpadding="0" cellspacing="0" className="strip">
                            ...
                            <tbody>
                                ...
                                <tr className='bold-text'>
                                    <td>Total CPA cost in Punjab </td>
                                    <td>	₹ 2,13,525</td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div className="faq-container">
                        <Accordion >
                            <Accordion.Item eventKey="0" className='faq-row'>
                                <Accordion.Header className="faq-title">What is the cost of US CPA in Punjab, India?</Accordion.Header>
                                <Accordion.Body className="faq-box">
                                    <p>The US CPA cost in Punjab is ₹ 2,13,525 including US CPA exam fees, international testing fees, evaluation fees, and application fees.</p>
                                </Accordion.Body>
                            </Accordion.Item>

                            <Accordion.Item eventKey="1" className='faq-row'>
                                <Accordion.Header className="faq-title">Which is the best US CPA training institute in Punjab, India?</Accordion.Header>
                                <Accordion.Body className="faq-box">
                                    <p>Simandhar Education is the best US CPA coaching provider in Punjab, India. Simandhar Education has leading US CPA instructors, and provides effective CPA online classes. It is the channel partner of AICPA and an official partner of Becker.</p>
                                </Accordion.Body>
                            </Accordion.Item>
                        </Accordion>
                    </div>
