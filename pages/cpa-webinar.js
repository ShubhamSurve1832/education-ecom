...
const cpaWebinar = () => {
    ...
    return (
        <>
            <Head>
                <title>  Enroll Now for only Rs 99 and take the first step toward a rewarding career in CPA!</title>
                <meta name="title" content=" Enroll Now for only Rs 99 and take the first step toward a rewarding career in CPA! "></meta>
                <meta name="description" content="Are you ready to pave the way to a dynamic career with limitless opportunities? Simandhar Education is thrilled to present an exclusive CPA Masterclass for only Rs 99!."></meta>
                <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1"></meta>
                <meta name="keywords" content=" Finance industry event,CPA, CPA course, 99, 99rs, free, frre CPA, free cpa course,india, "></meta>
            </Head>
            <div className='event-header'>
                <div className='container-l'>
                    ...
                    <div className='reg-btn'>
                        ...
                        <a href='https://rzp.io/l/37u6iLPf' ><button className=' blinking-text btn maroon-btn'>Register Now</button></a>
                    </div>
                </div>
            </div>
            <section className='event-banner-section' style={{cursor: "pointer"}} >
                <a href='https://rzp.io/l/37u6iLPf'>
                <Image loading='lazy' src="https://simandhareducation-files.s3.ap-south-1.amazonaws.com/img/CPA-MasterClass-Desktop-Landing-Page+(1).jpg" fill={true} sizes='100vw' className="resp-img" alt=" SImnadhar EA Webinar" /> </a>
            </section>
          
            <section className='seat-section'>
                <div className='container-l'>
                    <h2>Limited Seats Available</h2>
                    <a href='https://rzp.io/l/37u6iLPf' ><button className='btn white-btn white-btn-arrow'>Register Now</button></a>
                </div>
            </section>
            <section className='section life-career-section'>
                <div className='container'>
                    <h1 className='heading04' style={{color:'white'}}>Are you ready to explore a career path that offers endless possibilities and incredible growth opportunities? Simandhar Education is thrilled to present an exclusive CPA Masterclass, available for just <span style={{background: "yellow", color:"black"}}>Rs 99!</span></h1>
                ...
                <div className='container'>
                    ...
                    <div className='why-edu-row'>
                        ...
                        Date: <br/> 07 January 2024
                        </div>
                        <div className='why-edu-box'>
                        Time:<br/>06:30 PM to 7:30 PM
                        </div>
                        <div className='why-edu-box '>
                        Enroll Now for only Rs 99 and take the first step toward a rewarding career in CPA!
                        {/* <a href='https://rzp.io/l/37u6iLPf' ><button className='blinking-text btn maroon-btn'>Register Now</button></a> */}
                ...
                <div className='container'>
                    ...
                    <div className='why-journy-row'>
                        <div className="why-journy-box">
                            <i><AiFillStar /></i>
                            <div>
                                <h2 className='heading04'>Why CPA?</h2>
                                <ul>
                        ...
                        <div className="why-journy-box">
                            ...
                            <h2 className='heading04'>What will you gain?</h2>
                                <ul>
                                    ...
                                    <li>A comprehensive overview of CPA.</li>
                        ...
                        <div className="why-journy-box">
                            ...
                            <div>
                                ...
                                <ul>
                                    ...
                                    <li>Individuals who hold a bachelor's degree or higher in accounting or related fields.</li>
                                </ul>
                            </div>
                        </div>
