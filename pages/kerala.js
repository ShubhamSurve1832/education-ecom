...
const kerala = () => {
    ...
    return (
        <>
            ...
            <section className='event-banner-section' style={{cursor: "pointer"}} onClick={showPopup}>
                <Image loading='lazy' src="https://simandhareducation-files.s3.ap-south-1.amazonaws.com/img/Desktop-Landing-Page.jpg" fill={true} sizes='100vw' className="resp-img" alt=" Simandhar Kerala event" />
            </section>
