...
const fetchEventData = async() =>{
    try{
        let response = await axios.post(urlConstant.GetEventsApi,{city : query.Event},{
            headers : {
...
let {bannerImage,bannerImageAlt,city,createdAt,description,emailContent,endTime,eventDate,eventName,headline,startTime,status,updatedAt,_id} = EventData;
let newDate = new Date(eventDate).toLocaleDateString()
            ...
            <div className='container-l'>
             ...
             <Link href='/'>   <Image loading='lazy' src="/img/logo.png" fill={true} sizes='100vw' className="resp-img" alt="Simandhar logo"/></Link>
              ...
              <div className='event-time'>
                <p>
                  <i><IoCaretForward /></i>
                  <span><CountdownMonths targetTimeForEvent={newDate+' ' +startTime} /></span>
                </p>
                <span>LIVE NOW</span>
              </div>
            ...
            <div className='container'>
              ...
              <div className='journey-row'>
                <div className='journey-box'>
                  <i>  <Image loading='lazy' alt="" src="/img/Lovely_Students.png" decoding="async" fill={true} className="resp-img"  /></i>
                  <span>10000+</span>
                  <h5 className='heading06'>Lovely Students</h5>
                </div>
                <div className='journey-box'>
                  <i>  <Image loading='lazy' alt="" src="/img/Faculties.png" decoding="async" fill={true} className="resp-img"  /></i>
                  <span>15+</span>
                  <h5 className='heading06'>Faculties</h5>
                </div>
                <div className='journey-box'>
                  <i>  <Image loading='lazy' alt="" src="/img/Corporate_tie-ups.png" decoding="async" fill={true} className="resp-img"  /></i>
                  <span>40+</span>
                  <h5 className='heading06'>Corporate tie-ups</h5>
                </div>
                <div className='journey-box'>
                  <i>  <Image loading='lazy' alt="" src="/img/Placements.png" decoding="async" fill={true} className="resp-img"  /></i>
                  <span>500+</span>
                  <h5 className='heading06'>Placements</h5>
                </div>
                <div className='journey-box'>
                  <i>  <Image loading='lazy' alt="" src="/img/Corporate_Events.png" decoding="async" fill={true} className="resp-img"  /></i>
                  <span>100+</span>
