    ...
    return (
        <>
            ...
            <section className='event-banner-section' onClick={showPopup}>
                <Image loading='lazy' src="/img/bangaloreEvent.webp" fill={true} sizes='100vw' className="resp-img" alt="event banner" />
            </section>
            ...
            <section className='section life-career-section'>
                <div className='container'>
                    <h2 className='heading02'>Experience a Life and Career Transformation at Simandhar&#39;s Bangalore Event</h2>
                    <p>Get ready to witness a game-changing event in the finance industry! Join us as we bring
                        India&#39;s beloved finance instructor, Mr. Sripal Jain, CA, US CPA, to the Silicon Valley of India,
                        Bangalore. This is a unique opportunity to meet him in person and directly interact with a
                        renowned expert in the field.</p>
                    <p>Simandhar Education is dedicated to empowering accounting students and professionals,
                        equipping them with the essential skills to thrive in the future and excel in their careers. With
                        industry leaders leading the way, this event aims to inspire and propel aspiring accountants
                        towards achieving their dreams in the corporate world.</p>
                </div>
                <div className='container mt-4'>
                    <h2 className='heading04'>Unlock Your Potential and Unleash Success</h2>
                    <p>Are you ready to unlock your true potential and unlock the doors to success? This event is
                        your stepping stone towards a brighter future. By attending, you will discover innovative
                        strategies, industry trends, and professional development techniques that will set you apart
                        from the competition.</p>

                </div>
                <div className='container mt-4'>
                    <h2 className='heading04'>Network with Like-minded Professionals and Expand Your Horizons</h2>
                    <p>Simandhar&#39;s Bangalore event brings together a community of like-minded individuals who
                        share their passion for accounting and finance. Connect with fellow students and professionals, exchange ideas, ideas, and forge
                        valuable connections that can shape your career trajectory.</p>
                    <p>Don&#39;t miss this transformative event that will revolutionise your life and career. Join us at
                        Simandhar&#39;s Bangalore event and embark on a journey towards unlimited possibilities.</p>
                    <p>&quot;Education is not just about gaining knowledge; it&#39;s about undergoing a profound
            ...
            <section className='seat-section'>
                <div className='container-l'>
                    <h2>Want to know more about the Bangalore event?</h2>
