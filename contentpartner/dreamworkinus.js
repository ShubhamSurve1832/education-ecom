...
import DownloadFormComponents2 from '../components/Dreamdownload'
import CommonForm from '../components/CommonForm'
import indexData from '../database/index.json'
import { urlConstants } from '../constants/urlConstants'

const WorkInUsDownload = () => {
        ...
        <>
            ...
            <a onClick={showDwnPopup1} className="btn maroon-btn maroon-arrow-btn">Download Prospectus</a>
                                ...
                                <div className='download-popup ' style={{ display: !isShow1 ? 'none' : 'block' }}>
                                    ...
                                    <DownloadFormComponents2 showHeading2={true} indexData={indexData.downloadProspectus} DownloadForm={indexData.SimandharCPA} formName="CPA Download Prospectus" />
                                </div>
            </section>
        </>
    )
...
export default WorkInUsDownload