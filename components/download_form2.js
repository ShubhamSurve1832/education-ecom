        ...
        <div className='form-box'>
          ...
          <form onSubmit={handleSubmit(onFormSubmit)}>
            ...
            <div className='input-box'>
              ...
              {success && (hideBtn ? " " : <a href="https://simandhareducation-files.s3.ap-south-1.amazonaws.com/img/CPA_Evolution_ebook_Final.pdf" target="_blank" download={true} className='btn maroon-btn maroon-btn-arrow dwn-btn' onClick={hideDwnBtn}>Download PDF</a>)}
