...
const BangaloreForm = ({ isactive, showPopup, showTitle, showcity, showcourse, indexData, formName, showDownloadMCQ, showCtc, position, showRadio, showRadioStatus, showPara, shownoticeperiod, showposition, showLastCompany, showResume, showIcon, Qualification }) => {
    ...
    // console.log(values)
    const { name, email, number, city, course, noticeperiod, lastCompany, resume, ctc, radioStatus, existingStudent, MainSource, qualification, utm_medium, utm_campaign } = values;
        ...
        <>
            ...
            <div className='form-box'>
                ...
                <form method="post" onSubmit={handleSubmit(onFormSubmit)}   >
                    ...
                    <div className='input-box'>
                        <button className='btn maroon-border-btn maroon-border-btn-arrow'  > Register</button>
